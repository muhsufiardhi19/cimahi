...
class Main extends CI_Controller {
	...
	public function hibah2($tp='', $dx=0)
	{
		$this->load->view('template/meta');
		$this->load->view('template/header');
		if(isset($_SESSION['sabilulungan']) && $_SESSION['sabilulungan']['role']==6 || $_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==5 || $_SESSION['sabilulungan']['role']==9) $this->load->view('content/hibah2', array('tp' => $tp,'dx' => $dx));
		else $this->load->view('content/login');
		$this->load->view('template/footer');		
	}
	...
	public function tatausaha2($tp='', $dx=0)
	{
		$this->load->view('template/meta');
		$this->load->view('template/header');
		if(isset($_SESSION['sabilulungan']) && $_SESSION['sabilulungan']['role']==5 || $_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==9) $this->load->view('content/t', array('tp' => $tp,'dx' => $dx));
		else $this->load->view('content/login');
		$this->load->view('template/footer');		
	}
	...
	public function walikota2($tp='', $dx=0)
	{
		$this->load->view('template/meta');
		$this->load->view('template/header');
		if(isset($_SESSION['sabilulungan']) && $_SESSION['sabilulungan']['role']==1 || $_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==9) $this->load->view('content/9', array('tp' => $tp,'dx' => $dx));
		else $this->load->view('content/login');
		$this->load->view('template/footer');		
	}
	...
	public function admin2($tp='', $dx=0)
	{
		$this->load->view('template/meta');
		$this->load->view('template/header');
		if(isset($_SESSION['sabilulungan']) && $_SESSION['sabilulungan']['role']==5 || $_SESSION['sabilulungan']['role']==9 || $_SESSION['sabilulungan']['role']==7) $this->load->view('content/8', array('tp' => $tp,'dx' => $dx));
		else $this->load->view('content/login');
		$this->load->view('template/footer');		
	}
