    ...
    <div class="wrapper">
        ...
        if($_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==9) echo '<thead>
            ...
            <tr>
                ...
                <th>1. Pemeriksaan TU</th>
                <th>2. Pemeriksaan Walikota</th>
                <th>3. Pemeriksaan Tim Pertimbangan</th>
                <th>4. Pemeriksaan SKPD</th>
                <th>5. Verifikasi Tim Pertimbangan</th>
                <th>6. Verifikasi TAPD</th>
                <th>7. Penyetujuan Walikota</th>
				<th>8. Pemeriksaan Proposal TU</th>
                <th>9. Tahapan Walikota I</th>
				<th>10. Kajian Pencairan</th>
				<th>11. Tahapan Walikota II</th>
                <th>12. Pencairan</th>
                <th>LPJ</th>
            </tr>
        </thead>';
            ...
            <tr>
                ...
                <th>Hasil Evaluasi</th>
                <th>Pertimbangan TAPD</th>
				<th>I. Pemeriksaan TU</th>
                <th>II. Pemeriksaan Walikota</th>
                <th>III. Pemeriksaan Tim Pertimbangan</th>
                <th>IV. Pemeriksaan SKPD</th>
                <th>V. Verifikasi Tim Pertimbangan</th>
                <th>VI. Verifikasi TAPD</th>
                <th>VII. Penyetujuan Walikota</th>
				<th>VIII. Pemeriksaan Proposal TU</th>
                <th>IX. Tahapan Walikota I</th>
				<th>X. Kajian Pencairan</th>
				<th>XI. Tahapan Walikota II</th>
                <th>XII. Pencairan</th>
            </tr>
        </thead>';
        ?>        
        ...
        if(isset($_POST['search'])){
            //Query Search
            $walikota = array(1,6,9,11); $pertimbangan = array(2,4); $tatausaha = array(NULL, 0, 8); $tapd = array (5,10);
            if($_SESSION['sabilulungan']['role']==5) $Qlist = $this->db->select("id, name, address, judul, current_stat, nphd, tanggal_lpj")->from('proposal')->like('judul', $_POST['keyword'])->where_in('current_stat', $tatausaha)->order_by('id', 'DESC')->limit($limit, $position)->get();
            ...
            elseif($_SESSION['sabilulungan']['role']==2) $Qlist = $this->db->select("id, name, address, judul, current_stat, nphd, tanggal_lpj")->from('proposal')->like('judul', $_POST['keyword'])->where_in('current_stat', $tapd)->order_by('id', 'DESC')->limit($limit, $position)->get();
            ...
            $walikota = array(1,6,9,11); $pertimbangan = array(2,4); $tapd = array (5,10); $tatausaha = array(NULL, 0, 8); $sskpd = $_SESSION['sabilulungan']['skpd'];
            if($_SESSION['sabilulungan']['role']==5) $stat .= " AND current_stat IN ($tatausaha)";
            ...
            //Query List
            $walikota = array(1,6,9,11); $pertimbangan = array(2,4);
            $tatausaha = array(NULL, 0, 8); $tapd = array (5,10);
            if($_SESSION['sabilulungan']['role']==5) $Qlist = $this->db->select("id, name, address, judul, current_stat, nphd, tanggal_lpj")->from('proposal')->where_in('current_stat', $tatausaha)->order_by('id', 'DESC')->limit($limit, $position)->get();
            ...
            elseif($_SESSION['sabilulungan']['role']==2) $Qlist = $this->db->select("id, name, address, judul, current_stat, nphd, tanggal_lpj")->from('proposal')->where_in('current_stat', $tapd)->order_by('id', 'DESC')->limit($limit, $position)->get();
            ...
            foreach($Qlist->result_object() as $list){
                ...
                echo '<tr>
                        ...
                        elseif($list->current_stat==2 && $_SESSION['sabilulungan']['role']==4 || $list->current_stat==2 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==2 && $_SESSION['sabilulungan']['role']==9){
                            ...
                            if($_SESSION['sabilulungan']['role']==4){
                                echo '<td style="text-align:center">PROSES</td>';
                            }
                            if($_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==9){
                                if($_SESSION['sabilulungan']['role']==9){
                        ...
                        elseif($list->current_stat==3 && $_SESSION['sabilulungan']['role']==3 || $list->current_stat==3 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==3 && $_SESSION['sabilulungan']['role']==9){
							...
							echo '<td style="text-align:center">PROSES</td>';
                            echo '<td style="text-align:center">PROSES</td>';
                             if($_SESSION['sabilulungan']['role']==3){
                                echo '<td style="text-align:center">PROSES</td>';
                            }
                            if($_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==9){
                                if($_SESSION['sabilulungan']['role']==9){
                        ...
                        elseif($list->current_stat==5 && $_SESSION['sabilulungan']['role']==2 || $list->current_stat==5 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==5 && $_SESSION['sabilulungan']['role']==9){
                            ...
                            echo '<td style="text-align:center">PROSES</td>';
                             ...
                             if($_SESSION['sabilulungan']['role']==2){
                                echo '<td style="text-align:center">PROSES</td>';
                            }
                        ...
                        elseif($list->current_stat==7 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==7 && $_SESSION['sabilulungan']['role']==9){
							...
							//edited sufi
							/*echo '<td style="text-align:center"><a href="'.site_url('admin2/nphd/'.$list->id).'">PROSES</a></td>';*/
                            echo '<td style="text-align:center">PROSES</td>';
                            echo '<td style="text-align:center">PROSES</td>';
							echo '<td style="text-align:center">PROSES</td>';
                            echo '<td style="text-align:center">PROSES</td>';
                        ...
                        //edit ferdi        
                        }elseif($list->current_stat==8 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==8 && $_SESSION['sabilulungan']['role']==5 || $list->current_stat==8 && $_SESSION['sabilulungan']['role']==9){
                        ...
                        }elseif($list->current_stat==9 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==9 && $_SESSION['sabilulungan']['role']==9 || $list->current_stat==9 && $_SESSION['sabilulungan']['role']==1){
                            if($_SESSION['sabilulungan']['role']==9){
                                echo '<td style="text-align:center"><a href="'.site_url('tatausaha/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('walikota/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('pertimbangan/edit/'.$list->id).'">EDIT</a></td>';
                                ...
                                echo '<td style="text-align:center"><a href="'.site_url('tapd/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('walikota/view/'.$list->id).'">EDIT</a></td>';
								echo '<td style="text-align:center"><a href="'.site_url('admin2/edit/'.$list->id).'">EDIT</a></td>';
                            }else{
                                $Qstat = $this->db->query("SELECT action FROM proposal_approval WHERE `proposal_id`='$list->id'");
                            ...
                            echo '<td style="text-align:center"><a href="'.site_url('walikota2/edit/'.$list->id).'">PROSES</a></td>';
							echo '<td style="text-align:center">PROSES</td>';
                            echo '<td style="text-align:center">PROSES</td>';
                        ...
                        }elseif($list->current_stat==10 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==10 && $_SESSION['sabilulungan']['role']==9 || $list->current_stat==10 && $_SESSION['sabilulungan']['role']==2){
                            if($_SESSION['sabilulungan']['role']==9){
                                echo '<td style="text-align:center"><a href="'.site_url('tatausaha/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('walikota/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('pertimbangan/edit/'.$list->id).'">EDIT</a></td>';
                                ...
                                echo '<td style="text-align:center"><a href="'.site_url('walikota/view/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('admin2/edit/'.$list->id).'">EDIT</a></td>';
								echo '<td style="text-align:center"><a href="'.site_url('walikota2/view/'.$list->id).'">EDIT</a></td>';
                            ...
                            //edited sufi
                            //echo '<td style="text-align:center"><a href="'.site_url('admin2/nphd/'.$list->id).'">PROSES</a></td>';                            
                            echo '<td style="text-align:center"><a href="'.site_url('tapd/pencairan/'.$list->id).'">PROSES</a></td>';
                            echo '<td style="text-align:center">PROSES</td>';
                           // echo '<td style="text-align:center">PROSES</td>';
                        ...
                        }elseif($list->current_stat==11 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==11 && $_SESSION['sabilulungan']['role']==9 || $list->current_stat==11 && $_SESSION['sabilulungan']['role']==1){
                            if($_SESSION['sabilulungan']['role']==9){
                                echo '<td style="text-align:center"><a href="'.site_url('tatausaha/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('walikota/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('pertimbangan/edit/'.$list->id).'">EDIT</a></td>';
                                ...
                                echo '<td style="text-align:center"><a href="'.site_url('admin2/edit/'.$list->id).'">EDIT</a></td>';
								echo '<td style="text-align:center"><a href="'.site_url('walikota2/view/'.$list->id).'">EDIT</a></td>';
								echo '<td style="text-align:center"><a href="'.site_url('tapd/pencairan2/'.$list->id).'">EDIT</a></td>';
                            }else{
                                $Qstat = $this->db->query("SELECT action FROM proposal_approval WHERE `proposal_id`='$list->id'");
                            ...
                            //edited sufi
                            //echo '<td style="text-align:center"><a href="'.site_url('admin2/nphd/'.$list->id).'">PROSES</a></td>';                            
                            echo '<td style="text-align:center"><a href="'.site_url('walikota/verifikasi2/'.$list->id).'">PROSES</a></td>';
                           //echo '<td style="text-align:center">PROSES</td>';
                           // echo '<td style="text-align:center">PROSES</td>';
                        ...
                        }elseif($list->current_stat==12 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==12 && $_SESSION['sabilulungan']['role']==9){
                            if($_SESSION['sabilulungan']['role']==9){
                                echo '<td style="text-align:center"><a href="'.site_url('tatausaha/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('walikota/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('pertimbangan/edit/'.$list->id).'">EDIT</a></td>';
								...
								echo '<td style="text-align:center"><a href="'.site_url('walikota2/view/'.$list->id).'">EDIT</a></td>';
								echo '<td style="text-align:center"><a href="'.site_url('tapd/pencairan2/'.$list->id).'">EDIT</a></td>';
								echo '<td style="text-align:center"><a href="'.site_url('walikota/verifikasi2/'.$list->id).'">EDIT</a></td>';
                            }else{
                                $Qstat = $this->db->query("SELECT action FROM proposal_approval WHERE `proposal_id`='$list->id'");
