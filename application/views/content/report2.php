...
<div role="main" class="content-main" style="margin:120px 0 50px">
    <div class="wrapper">
        ...
        if(isset($_POST['search'])){
            //Query Search
            $walikota = array(1,6,9,11); $pertimbangan = array(2,4); $tatausaha = array(NULL, 8); $tapd = array (5,10);
            ...
            $walikota = array(1,6,9,11); $pertimbangan = array(2,4); $tapd = array (5,10); $tatausaha = array(NULL, 8); $sskpd = $_SESSION['sabilulungan']['skpd'];
            ...
            $tatausaha = array(NULL, 8); $tapd = array (5,10);
        ...
        if($Qlist->num_rows){
            foreach($Qlist->result_object() as $list){
                ...
                echo '<tr>
                        ...
                        //edit ferdi        
                        }elseif($list->current_stat==8 && $_SESSION['sabilulungan']['role']==7 || $list->current_stat==8 && $_SESSION['sabilulungan']['role']==5){

                            echo $list->current_stat;
                            if($_SESSION['sabilulungan']['role']==9){
                                echo '<td style="text-align:center"><a href="'.site_url('tatausaha/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('walikota/edit/'.$list->id).'">EDIT</a></td>';
                                echo '<td style="text-align:center"><a href="'.site_url('pertimbangan/edit/'.$list->id).'">EDIT</a></td>';
