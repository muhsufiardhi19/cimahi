                ...
                <div class="control-group">
                    ...
                    foreach($Qdana->result_object() as $dana){
                        echo '<div class="controls file">
                                <label class="control-label" style="font-weight:normal"><input type="checkbox" name="del_dana[]" value="'.$dana->sequence.'"> Reset Dana</label>
		...
		<div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls file">
                        ...
                        <input type="number" name="jumlah[]" placeholder="Jumlah" onchange="myFunction()">
                    </div>
                     <a id="dana" class="danas" onclick="addDana()" for="">Tambah Dana</a>
                </div>
